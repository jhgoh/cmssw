...
# Schedule definition
process.schedule = cms.Schedule(process.generation_step,process.genfiltersummary_step,process.simulation_step,process.digitisation_step,process.rpcrechits_step,process.simCppfDigis_step,process.endjob_step,process.FEVTDEBUGHLToutput_step)
